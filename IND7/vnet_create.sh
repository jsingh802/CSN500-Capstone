...
az network vnet peering create --resource-group $RG_Name --name StudenttoRouter --vnet-name $Student_vnet --remote-vnet $ --allow-vnet-access --allow-forwarded-traffic 
az network vnet peering create --resource-group $RG_Name --name RoutertoServer --vnet-name $Router_vnet --remote-vnet $ --allow-vnet-access --allow-forwarded-traffic 
az network vnet peering create --resource-group $RG_Name --name ServertoRouter --vnet-name $Server_vnet --remote-vnet $ --allow-vnet-access --allow-forwarded-traffic 
# --> Your Code in here
